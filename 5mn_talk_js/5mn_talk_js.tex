...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.188\textwidth}
         \centering
         \includegraphics[width=0.85\textwidth]{agramfort}
         \caption{A. Gramfort}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.188\textwidth}
         \centering
		\includegraphics[width=0.85\textwidth]{jsalmon}
         \caption{J. Salmon}
     \end{subfigure}
	 \hfill
     \begin{subfigure}[b]{0.188\textwidth}
         \centering
		 \includegraphics[width=0.85\textwidth]{mmassias}
         \caption{M. Massias}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.188\textwidth}
         \centering
		\includegraphics[width=0.85\textwidth]{tomdlt}
        \caption{T. Dupré la Tour}
     \end{subfigure}
	 \hfill
     \begin{subfigure}[b]{0.188\textwidth}
         \centering
		\includegraphics[width=0.85\textwidth]{tommoral}
